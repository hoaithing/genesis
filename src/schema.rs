...
diesel::table! {
    custom_offer_custombenefit (id) {
        ...
        #[max_length = 255]
        name -> Varchar,
        product_types -> Array<Nullable<Text>>,
    }
}
...
diesel::table! {
    shop_module_salepartner (id) {
        ...
        package_id -> Nullable<Int4>,
        #[max_length = 200]
        package_country -> Nullable<Varchar>,
        #[max_length = 255]
...
diesel::table! {
    sim_package (id) {
        ...
        used -> Int4,
        #[max_length = 255]
        joytel_order_id -> Nullable<Varchar>,
        #[max_length = 255]
        joytel_recharge_code -> Nullable<Varchar>,
        #[max_length = 255]
